...
export const COMMAND_FLAGS = Object.freeze({
  ...
  FLAG_ERASE_NETWORKSTORAGE_REQUEST: 140,

  FLAG_MERGE_NETWORKSTORAGE_REQUEST: 141,
  FLAG_SYNC_NETWORKSTORAGE_DATA_REQUEST: 142,
  FLAG_WRITE_NETWORKSTORAGE_DATA_REQUEST: 143,
  FLAG_READ_NETWORKSTORAGE_DATA_REQUEST: 144,

  FLAG_TX_MESSAGE_REQUEST: 145,
  FLAG_RX_MESSAGE_REQUEST: 146,

  FLAG_SYNC_CONTROLLERSTORE_WITH_CONNECTION_REQUEST: 147,
  FLAG_SYNC_NOTIFICATIONSTORE_WITH_CONNECTION_REQUEST: 148,
  FLAG_SYNC_NETWORKSTORAGE_WITH_CONNECTION_REQUEST: 149,

  FLAG_SYNC_CONTROLLERSTORE_REQUEST: 150,
  FLAG_SYNC_NOTIFICATIONSTORE_REQUEST: 151,
  FLAG_SYNC_NETWORKSTORAGE_REQUEST: 152,

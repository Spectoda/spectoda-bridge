 ...
 * @example 32
 */
export const PcbCodeSchema = z.number().int('PCB code must be an integer')
 ...
 * @example 24
 */
export const ProductCodeSchema = z.number().int('Product code must be an integer')
 ...
 * @example 1201
 */
export const FirmwareVersionCodeSchema = z.number().int('Firmware version code must be a positive integer')
 ...
 * @example 42
 */
export const TnglBankSchema = z.number().int('TNGL bank must be an integer')
 ...
 * @example 115200
 */
export const BaudrateSchema = z.number().int('Baudrate must be a positive integer')

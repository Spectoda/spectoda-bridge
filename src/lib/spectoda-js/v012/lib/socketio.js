...
function a(t, ...e) {
  return e.reduce((e, s) => (Object.hasOwn(t, s) && (e[s] = t[s]), e), {})
}
const h = setTimeout,
  c = clearTimeout
function p(t, e) {
    ...
    try {
      ...
      try {
        if (this.opts.extraHeaders) {
          ...
          for (const t in this.opts.extraHeaders)
            Object.hasOwn(this.opts.extraHeaders, t) &&
...
function V() {
  for (const t in U.requests)
    Object.hasOwn(U.requests, t) && U.requests[t].abort()
}
const H =
...
class $ extends u {
  ...
  createTransport(t) {
    const e = ((t) => {
      const e = {}
      for (const s in t) Object.hasOwn(t, s) && (e[s] = t[s])
      return e
    })(this.opts.query)
...
function tt(t, _e) {
  ...
  for (const e in t) if (Object.hasOwn(t, e) && tt(t[e])) return !0
  return !1
}
function et(t) {
  const e = [],
...
function st(t, e) {
  ...
  if ('object' === typeof t && !(t instanceof Date)) {
    const s = {}
    for (const n in t) Object.hasOwn(t, n) && (s[n] = st(t[n], e))
    return s
  }
  return t
}
...
function rt(t, e) {
  if (!t) return t
  if (t?._placeholder) return e[t.num]
  if (Array.isArray(t)) for (let s = 0; s < t.length; s++) t[s] = rt(t[s], e)
  else if ('object' === typeof t)
    for (const s in t) Object.hasOwn(t, s) && (t[s] = rt(t[s], e))
  return t
}
const it = 5
var ot
...
class lt extends u {
  ...
  emit(t, ...e) {
    if (Object.hasOwn(ut, t)) throw new Error(`"${t}" is a reserved event name`)
    e.unshift(t)
    ...
    const n = this.io.engine?.transport?.writable
    return (
  ...
  ack(t) {
    let s = !1
    return (...n) => {
      s || ((s = !0), this.packet({ type: ot.ACK, id: t, data: n }))
    }
  }
  onack(t) {

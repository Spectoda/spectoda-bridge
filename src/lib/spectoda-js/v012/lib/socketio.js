...
var t =
  ...
  s = function (s) {
    ...
    return (
      -1 != r && -1 != i && ((c.source = n), (c.host = c.host.substring(1, c.host.length - 1).replace(/;/g, ":")), (c.authority = c.authority.replace("[", "").replace("]", "").replace(/;/g, ":")), (c.ipv6uri = !0)),
...
(d.open = "0"), (d.close = "1"), (d.ping = "2"), (d.pong = "3"), (d.message = "4"), (d.upgrade = "5"), (d.noop = "6");
  ...
  b = ({ type: t, data: e }, s, n) => {
    return m && e instanceof Blob
      ? s
        ? n(e)
        : v(e, n)
      : g && (e instanceof ArrayBuffer || ((r = e), "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(r) : r && r.buffer instanceof ArrayBuffer))
        ? s
          ? n(e)
          : v(new Blob([e]), n)
        : n(d[t] + (e || ""));
    ...
    if (_) {
      const s = (function (t) {
        ...
        var c = new ArrayBuffer(o),
          p = new Uint8Array(c);
        for (e = 0; e < a; e += 4)
          (s = w[t.charCodeAt(e)]), (n = w[t.charCodeAt(e + 1)]), (r = w[t.charCodeAt(e + 2)]), (i = w[t.charCodeAt(e + 3)]), (p[h++] = (s << 2) | (n >> 4)), (p[h++] = ((15 & n) << 4) | (r >> 2)), (p[h++] = ((3 & r) << 6) | (63 & i));
        return c;
      })(t);
      return R(s, e);
    }
...
class I extends B {
  ...
  uri() {
    ...
    !1 !== this.opts.timestampRequests && (t[this.opts.timestampParam] = j()),
      ...
      this.opts.port && (("https" === e && 443 !== Number(this.opts.port)) || ("http" === e && 80 !== Number(this.opts.port))) && (s = ":" + this.opts.port);
    const n = D.encode(t);
...
class z extends B {
  ...
  uri() {
    ...
    let s = "";
    this.opts.port && (("wss" === e && 443 !== Number(this.opts.port)) || ("ws" === e && 80 !== Number(this.opts.port))) && (s = ":" + this.opts.port),
...
class $ extends u {
  constructor(t, e = {}) {
    super(),
      ...
      t ? ((t = s(t)), (e.hostname = t.host), (e.secure = "https" === t.protocol || "wss" === t.protocol), (e.port = t.port), t.query && (e.query = t.query)) : e.host && (e.hostname = s(e.host).host),
      p(this, e),
      ...
      (this.opts = Object.assign(
        { path: "/engine.io", agent: !1, withCredentials: !1, upgrade: !0, timestampParam: "t", rememberUpgrade: !1, rejectUnauthorized: !0, perMessageDeflate: { threshold: 1024 }, transportOptions: {}, closeOnBeforeunload: !0 },
        e,
      )),
  ...
  createTransport(t) {
    ...
    const s = Object.assign({}, this.opts.transportOptions[t], this.opts, { query: e, socket: this, hostname: this.hostname, secure: this.secure, port: this.port });
    return new W[t](s);
  }
  open() {
    let t;
    if (this.opts.rememberUpgrade && $.priorWebsocketSuccess && -1 !== this.transports.indexOf("websocket")) t = "websocket";
    else {
...
class at extends u {
  ...
  add(t) {
    let e;
    if ("string" == typeof t)
      (e = this.decodeString(t)), e.type === ot.BINARY_EVENT || e.type === ot.BINARY_ACK ? ((this.reconstructor = new ht(e)), 0 === e.attachments && super.emitReserved("decoded", e)) : super.emitReserved("decoded", e);
    else {
...
const ut = Object.freeze({ connect: 1, connect_error: 1, disconnect: 1, disconnecting: 1, newListener: 1, removeListener: 1 });
class lt extends u {
  constructor(t, e, s) {
    super(),
      (this.connected = !1),
      ...
      switch (t.type) {
        case ot.CONNECT:
          if (t.data && t.data.sid) {
            ...
            this.emitReserved(
              "connect_error",
              new Error("It seems you are trying to reach a Socket.IO server in v2.x with a v3.x client, but they are not compatible (more information here: https://socket.io/docs/v3/migrating-from-2-x-to-3-0/)"),
            );
          break;
        case ot.EVENT:
        case ot.BINARY_EVENT:
...
class yt extends u {
  constructor(t, e) {
    ...
    super(),
      ...
      (this.backoff = new dt({ min: this.reconnectionDelay(), max: this.reconnectionDelayMax(), jitter: this.randomizationFactor() })),
...
function gt(t, e) {
  ...
  const n = (function (t, e = "", n) {
      ...
      (n = n || ("undefined" != typeof location && location)),
        ...
        "string" == typeof t && ("/" === t.charAt(0) && (t = "/" === t.charAt(1) ? n.protocol + t : n.host + t), /^(https?|wss?):\/\//.test(t) || (t = void 0 !== n ? n.protocol + "//" + t : "https://" + t), (r = s(t))),
